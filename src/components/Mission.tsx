      ...
      <div className="container px-6 md:px-12">
        <div className="max-w-5xl mx-auto">
          ...
          <div ref={featuresRef} className="grid md:grid-cols-4 gap-6 mt-16">
            {[
              { icon: "M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z", title: "Customized Schedules", desc: "Flexible timing to fit your needs 24/7", delay: 0 },
